  ...
  <Carousel className='principalCarousel vhh-50'>
    { firstCarousel.map(items =>
      <Carousel.Item key={ items.id }>
        <img src={ items.image } alt={ items.movieTitle } className='d-block imgCarouselOne w-100' />
        ...
        <Carousel.Caption>
          <div className='text-left col-12 vh-50 mx-auto'>
            ...
            <button type='button' className='btn btn-primary btnRegisterO'>Ver Película
              <a href='/'>
...
const mapStateToProps = state => ({ firstCarousel: state.firstCarousel })
